					...
					"result": 1,                                                     \
						...
						"data_list": [{                                              \
							...
							"virtual_network_list": [{                               \
								...
								{                                                    \
									"site_code": "algoblu_beijing",                  \
									"access_instance_id": 11,                        \
									"pe_code": "GW11",                               \
									"work_mode": "slave",                            \
									"tunnel_type": "openvpn",                        \
									"openvpn_client_ip": "172.40.11.12",             \
									"username": "u1499062623",                       \
									"password": "p37dE9y6"                           \
								}]                                                   \
							},                                                       \
							{                                                        \
								...
								{                                                    \
									"site_code": "algoblu_beijing",                  \
									"access_instance_id": 3,                         \
									"pe_code": "GW03",                               \
									"work_mode": "slave",                            \
									"tunnel_type": "openvpn",                        \
									"openvpn_client_ip": "172.40.3.12",              \
									"username": "u1499062623",                       \
									"password": "p37dE9y6"                           \
								},                                                   \
								{                                                    \
									"site_code": "algoblu_shanghai",                 \
									"access_instance_id": 4,                         \
									"pe_code": "GW04",                               \
									"work_mode": "master",                           \
									"tunnel_type": "openvpn",                        \
									"openvpn_client_ip": "",                         \
